...
function eden_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'eden' ),
	) );
...
function eden_scripts() {
	...
	wp_enqueue_style( 'open-sans', 'https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800,400italic,700italic' );
	...
	wp_enqueue_script( 'bootstrap-js', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js', array('jquery'), '20151023', true );

	wp_enqueue_script( 'eden-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'eden-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
